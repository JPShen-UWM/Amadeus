...
read_file -f sverilog [glob -nocomplain ../sv/sys_defs.svh ../sv/pe.sv ../sv/adder_fixed.sv ../sv/mult_fixed.sv src/*.v	src/*.sv src/*.vh src/*.svh]
set design_name pe
set clock_name clk
set reset_name rst
set CLK_PERIOD 10
...
## Set module with parameters
#analyze -f sverilog "branch_stack.sv"
#elaborate branch_stack_entry -parameter BRANCH_BIT=1
#design_name branch_stack_entry_0001
#
#analyze -f sverilog "branch_stack.sv"
#elaborate branch_stack_entry -parameter BRANCH_BIT=2
#design_name branch_stack_entry_0010
#
#analyze -f sverilog "branch_stack.sv"
#elaborate branch_stack_entry -parameter BRANCH_BIT=4
#design_name branch_stack_entry_0100
#
#analyze -f sverilog "branch_stack.sv"
#elaborate branch_stack_entry -parameter BRANCH_BIT=8
#design_name branch_stack_entry_1000
